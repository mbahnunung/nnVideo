/*
   detikVideo Object for Core-Developers
*/

// Chapter 1: Beginning
if (typeof jQuery !== 'function') {
  var warnJQueryUndefinedStr = 'detikVideo.core.js needs jQuery 1.1x.x to run properly!';
...
var detikVideo = {};
detikVideo.playerName     = 'detikVideo';
detikVideo.coreVersion    = '1.0.0'; // VideoJS v7.1.0 , VideoJS-Contrib-Ads v6.6.1 , VideoJS-IMA v1.5.2
detikVideo.companyName    = 'detikNetwork';
detikVideo.coreHeaderInfo = '[detikVideo.core]';

detikVideo.libs = {};
detikVideo.libs.protocol  = window.location.href.indexOf("https://") === 0 ? "https:" : "http:";
// basePath default for Production
detikVideo.libs.basePath      = 'https://cdn1.mbahnunungonline.net/detikVideo';
if (window.location.hostname.indexOf('127.0.0.1') !== -1) {
  // switch to basePath for Development if domain is 127.0.0.1
  detikVideo.libs.basePath    = detikVideo.libs.protocol+'//127.0.0.1/detikVideo';
} else if (window.location.hostname.indexOf('flowplugs')  !== -1) {
  // switch to basePath for Development if domain is flowplugs.*
  detikVideo.libs.basePath    = detikVideo.libs.protocol+'//flowplugs.detik.com/detikVideo';
} else if (window.location.hostname.indexOf('vidplayer')  !== -1 && window.location.href.indexOf('/detikVideoTest')  !== -1) {
  // switch to basePath for Development if domain is vidplayer.*/detikVideoTest
  detikVideo.libs.basePath    = detikVideo.libs.protocol+'//vidplayer.detik.com/detikVideoTest';
} else if (window.location.hostname.indexOf('vidplayer')  !== -1 && window.location.href.indexOf('/detikVideoDev')  !== -1) {
  // switch to basePath for Development if domain is vidplayer.*/detikVideoDev
  detikVideo.libs.basePath    = detikVideo.libs.protocol+'//vidplayer.detik.com/detikVideoDev';
} else if (window.location.hostname.indexOf('vidplayer')  !== -1) {
  // switch to basePath for Development if domain is vidplayer.*
  detikVideo.libs.basePath    = detikVideo.libs.protocol+'//vidplayer.detik.com/detikVideo';
} else if (window.location.hostname.indexOf('test-local')  !== -1) {
  // switch to basePath for Development if domain is test-local.*
  detikVideo.libs.basePath    = detikVideo.libs.protocol+'//test-local.detik.com';
} else if (window.location.hostname.indexOf('gitlab-ci')  !== -1) {
  // switch to basePath for Development if domain is gitlab-ci.detik.com
  detikVideo.libs.basePath    = 'https://detikVideo.gitlab-ci.detik.com/';
};

detikVideo.libs.vjsVersion    = 7;
detikVideo.libs.vjsCore       = '/lib/video.min.v7.1.0.js';
detikVideo.libs.vjsCoreAlt    = '/lib/video.min.v6.11.0.js';
detikVideo.libs.vjsLang       = '/lang/id.js';
detikVideo.libs.vjsHls        = '/lib/videojs-hlsjs-plugin.v1.0.5.js';
detikVideo.libs.vjsQPicker    = '/lib/vjs-quality-picker.v0.0.2.js';
detikVideo.libs.detectAB      = '/detikVideo.detect.js';
detikVideo.libs.detectABWithFck = '/detikVideo.detect2.js';
detikVideo.libs.vjsAds        = '/lib/videojs.ads.min.v6.6.1.js';
detikVideo.libs.vjsIma        = '/lib/videojs.ima.v1.5.2.bgfixadsmanager.js';
detikVideo.libs.pushstream    = '/lib/pushstream.js';
detikVideo.libs.Ima           = 'https://imasdk.googleapis.com/js/sdkloader/ima3_debug.js';
detikVideo.libs.vjsCueMarker  = '/lib/videojs-markers.min.v1.0.1.bgfixinit.js';
detikVideo.libs.vjsVR         = '/lib/videojs-vr.min.v1.5.0.js';
detikVideo.libs.portal        = '/detikVideo.portal.js';
detikVideo.libs.vjsContribHls = '/lib/videojs-contrib-hls.min.v5.14.1.js';
detikVideo.libs.jqCarousel    = '/lib/jquery.carousel-3d.min.v0.2.2.js';
detikVideo.libs.jqResize      = '/lib/jquery.resize.v0.5.3.js';
detikVideo.libs.jqWaitImage   = '/lib/jquery.waitforimages.v2.0.0.js';
detikVideo.libs.modernizr     = '/lib/modernizr.v2.8.3.js';
detikVideo.libs.canAutoplay   = '/lib/can-autoplay.min.v3.0.0.js';
detikVideo.libs.later         = '/lib/later.min.v1.2.0.js';

detikVideo.images = {};
detikVideo.images.basePath    = detikVideo.libs.basePath; // as default
detikVideo.images.vjsLoading  = '/img/empty1x1.png';

detikVideo.styles = {};
detikVideo.styles.basePath    = detikVideo.libs.basePath; // as default
detikVideo.styles.vjsCore     = '/css/video-js.v7.1.0.css';
detikVideo.styles.vjsCoreAlt  = '/css/video-js.v6.11.0.css';
detikVideo.styles.vjsAds      = '/css/videojs.ads.v6.6.1.css';
detikVideo.styles.vjsIma      = '/css/videojs.ima.v1.5.2.css';
detikVideo.styles.vjsCueMarker= '/css/videojs.markers.v1.0.1.css';
detikVideo.styles.jqCarousel  = '/css/jquery.carousel-3d.v0.2.2.css';
detikVideo.styles.custom      = '/css/videojs-custom.css';

detikVideo.scriptconf = {};
detikVideo.scriptconf.target        = 'player';
detikVideo.scriptconf.autoplay      = true;
detikVideo.scriptconf.mute          = false;
detikVideo.scriptconf.live          = false; // true means videoUrl is a live streaming, false is vod streaming
detikVideo.scriptconf.title         = null;
detikVideo.scriptconf.imageUrl      = '/detikVideo/img/blueredplay.png';
detikVideo.scriptconf.videoUrl      = null;
detikVideo.scriptconf.videoType     = 'application/x-mpegURL';
detikVideo.scriptconf.channel       = null;
detikVideo.scriptconf.adRules       = null;
detikVideo.scriptconf.vastTag       = undefined; // will be deprecated
detikVideo.scriptconf.hideControlbar= false;// player will hide its controlbar
detikVideo.scriptconf.adsManagerLoadedCallback        = undefined;
detikVideo.scriptconf.adsManagerInstantiationCallback = undefined;
detikVideo.scriptconf.detikVideoLoadedCallback        = undefined;
detikVideo.scriptconf.libs          = null;
detikVideo.scriptconf.images        = null;
detikVideo.scriptconf.styles        = null;
detikVideo.scriptconf.features      = null;
detikVideo.scriptconf.vjsconf       = null;
detikVideo.scriptconf.hlsjsconf     = null;
detikVideo.scriptconf.adsconf       = null;
detikVideo.scriptconf.cbadsconf     = null;
detikVideo.scriptconf.vrconf        = null;

detikVideo.features = {};
detikVideo.features.enableStringSrc  = true;
detikVideo.features.loadCustomCSS    = true;
detikVideo.features.smartAutoplay    = true; // can-autoplay loader and executor
detikVideo.features.smartAutoplayMuted = false;
detikVideo.features.smartAutoplayTimoutPerStep = 300; // ms
detikVideo.features.smartAutoplayAffectIMA = true;
// vod preload - begin - copycat detikFlow
detikVideo.features.vodPreload      = 'auto'; // default is 'auto', 'none', 'metadata', 'auto'
detikVideo.features.vodAutoStartLoad = true; // default is true, if true then vodPreload can be metadata or auto 
detikVideo.features.vodBufferWhilePausedAutoStop    = true; // default is false
detikVideo.features.vodBufferWhilePausedMaxSeconds  = 7000;  // default is 7000
// vod preload - end
// live preload- begin - copycat detikFlow
detikVideo.features.livePreload     = 'auto'; // default is 'auto', 'none', 'metadata', 'auto'
detikVideo.features.liveAutoStartLoad= false; // default is true, if true then livePreload can be metadata or auto
detikVideo.features.liveBufferWhilePausedAutoStop   = false; // default is false
detikVideo.features.liveBufferWhilePausedMaxSeconds = 7000;  // default is 7000
// live preload- end
detikVideo.features.liveOnlyImaCompletedThenPlayAgain=true;
detikVideo.features.enableHideSpinnerWhileAutoplayTrue  = true;
detikVideo.features.hideSpinnerWhileAutoplayTrueGapTime = 2000;
detikVideo.features.playsinlineString       = 'playsinline'; // String or emptyString ''
detikVideo.features.webkitplaysinlineString = 'webkit-playsinline'; // String or emptyString ''
detikVideo.features.stylesLoader    = true;
detikVideo.features.logTextarea     = false; // set this value from coreInit()
detikVideo.features.logTextarea2    = false; // set this value from coreInit(), log is inside LogModal
detikVideo.features.logTextareaCheckRetry = 1; // trying to get textareaId  in X+1 times
detikVideo.features.logTextarea2CheckRetry= 1; // trying to get textareaId2 in X+1 times
detikVideo.features.logModalCols    = null;
detikVideo.features.logModalRows    = null;
detikVideo.features.logModalColWidth  = 7; // in px
detikVideo.features.logModalRowHeight = 10;// in px
detikVideo.features.logModalVGap    = 200; // in px
detikVideo.features.logModalHGap    = 150; // in px
detikVideo.features.logModalVGap2   = 350; // in px
detikVideo.features.logModalHGap2   = 250; // in px
detikVideo.features.logModalPlayerWidthDefault  = 640; // in px just for assumption
detikVideo.features.logModalPlayerHeightDefault = 360; // in px just for assumption
detikVideo.features.ajaxSetupCache  = true;
detikVideo.features.ajaxSetupASync  = true;
detikVideo.features.vjsLoaderAjaxSetupCache   = false;
detikVideo.features.vjsLoaderAjaxSetupASync   = true;
detikVideo.features.vjsLoaderWaitingVJSFunction=false;
detikVideo.features.vjsLoaderWaitingTimout     = 100; // in ms
detikVideo.features.vjsLoaderWaitingCheckRetry = 3;
detikVideo.features.vTail           = true;
detikVideo.features.detectAB        = true;
detikVideo.features.detectABWithFck = false; // false v1 is detikVideo.detect.js, true v2 is detikVideo.detect2.js
detikVideo.features.loadIma         = true;
detikVideo.features.loadDrawCueMarker   = true;
detikVideo.features.cueMarkerText   = 'Iklan';
detikVideo.features.drawAdCueMarkersGapTime = 3000; // milliseconds
detikVideo.features.cueMarkerStyle  = {
  'width':'4px',
  'border-radius':'8%',
  'background-color':'red'
};
detikVideo.features.detectFlowPlayer = false;
detikVideo.features.loadByDiv       = false;
detikVideo.features.loadByDivStyle = ''; //'background-color: white;';
detikVideo.features.loadVR          = false;
detikVideo.features.skipLibGetScripts               = false;
detikVideo.features.getScriptToBodyAppend           = false;
detikVideo.features.checkAndroid4ThenGetScriptToBodyAppend = true;
detikVideo.features.loadGetAllowedStartLevel        = true;
detikVideo.features.suppressedStartLevel            = 0;
detikVideo.features.restoreCustomPlaybackStateOnAdBreakComplete = true;
// videojs-contrib-hls is new engine builtin videojs-core v7.x, it has a different event comparing with videojs-hlsjs
detikVideo.features.loadVjsContribHls               = false;
detikVideo.features.loadVjsLoadingByDomain          = true;
detikVideo.features.vjsLoadingByDomain      = [
  { domain: 'pasangmata.detik.com',         image: '/img/pasangmata.png' },
...
detikVideo.features.loadColorThemeByDomain  = true;
detikVideo.features.playProgressColor       = null;
detikVideo.features.volumeLevelColor        = null;
detikVideo.features.markerColor             = null;
detikVideo.features.backgroundColor         = '#fff'; //'rgba(43, 51, 63, 0.7)';
detikVideo.features.colorThemeByDomain      = [
  { domain: 'pasangmata.detik.com',            playProgressColor: 'white', volumeLevelColor: 'white', markerColor: 'red', backgroundColor: '#fff' },
...
detikVideo.features.reloadVideoAtEnd           = false;
detikVideo.features.loadXhrIASDetector         = false;
detikVideo.features.loadVjsGeneralMenu         = false; // true is good
detikVideo.features.vjsGMButtonLabel           = 'Menu Umum';
detikVideo.features.vjsGMItemLogLabel          = 'Metadata';
detikVideo.features.vjsGMItemRelatedVideoLabel = 'Video Terkait';
detikVideo.features.loadVjsRelatedVideoModal   = false;
detikVideo.features.relatedVideoModalUrl       = '';
detikVideo.features.showRelatedVideoModalAtEnd = false;
detikVideo.features.vjsGMItemRelatedVideo3DLabel  = 'Video Terkait Carousel';
detikVideo.features.loadVjsRelatedVideoModal3D    = false;
detikVideo.features.relatedVideoModal3DContent    = '';
detikVideo.features.showRelatedVideoModal3DAtEnd  = false;
detikVideo.features.patchingHdButtonTitle = true;
detikVideo.features.hdButtonTitle         = 'Kualitas Video';
detikVideo.features.patchingVjsBgImgFromUrl = false;
detikVideo.features.enableLivePlaybackRates = false;
detikVideo.features.enableVodPlaybackRates  = false; // true is good
detikVideo.features.controlBarChildren = { 
  playToggle: true,
  volumePanel: true,
...
detikVideo.features.enableGSReviver        = true;
detikVideo.features.gsReviverImaTimeout    = 4000;
detikVideo.features.gsReviverVjsAdsTimeout = 4000;
detikVideo.features.gsReviverVjsImaTimeout = 4000;
detikVideo.features.enableLiveAdsInterval  = false;
detikVideo.features.liveAdsIntervalAdRules = [];      // array of string
detikVideo.features.liveAdsIntervalTimeout = 120000;  // 2 minutes
detikVideo.features.enableLiveAdsServerPush   = false;
detikVideo.features.liveAdsServerPushStream   = null;
detikVideo.features.liveAdsServerPushHost     = 'vidio.detik.com';
detikVideo.features.liveAdsServerPushPort     = '80';
detikVideo.features.liveAdsServerPushModes    = 'websocket|eventsource|stream';
detikVideo.features.liveAdsServerPushChannel  = 'liveAds';
detikVideo.features.liveAdsServerPushLogLevel = null; // or 'debug'
detikVideo.features.liveAdsServerPushRequestAdsTimeout      = 250;   // in ms
detikVideo.features.liveAdsServerPushWaitingForAllowMessage = 10000; // in ms
detikVideo.features.enableLiveAdsCron         = false;
detikVideo.features.liveAdsCronHasSeconds     = false;         
detikVideo.features.liveAdsCronData           = [
  {
...
detikVideo.vjsconf = {};
detikVideo.vjsconf.id               = 'player';
detikVideo.vjsconf.autoplay         = false;  // false, true, 'muted', 'play', 'any'
detikVideo.vjsconf.controls         = true;   // false, true
detikVideo.vjsconf.height           = undefined;   // string, number
detikVideo.vjsconf.width            = undefined;   // string, number
detikVideo.vjsconf.loop             = false;  // false, true
detikVideo.vjsconf.muted            = false;  // false, true
detikVideo.vjsconf.poster           = null;   // string
detikVideo.vjsconf.preload          = 'none'; // 'none', 'metadata', 'auto'
detikVideo.vjsconf.src              = null;   // string
detikVideo.vjsconf.aspectRatio      = '16:9'; // '16:9', '4:3'
detikVideo.vjsconf.autoSetup        = false;  // false, true
detikVideo.vjsconf.fluid            = true;   // false, true
detikVideo.vjsconf.inactivityTimeout= 3000;      // number in milliseconds
detikVideo.vjsconf.language         = 'id';   // 'en', 'id'
detikVideo.vjsconf.languages        = null;   // Object
detikVideo.vjsconf.notSupportedMessage = 'Maaf, Player tidak dapat menayangkan sumber media ini'; // string
detikVideo.vjsconf.playbackRates    = [0.5, 1, 1.5, 2]; // Array of Numbers
detikVideo.vjsconf.plugins          = null;   // Object ex: { foo: {bar: true}, boo: {baz: false} }
detikVideo.vjsconf.sources          = null;   // Array ex: sources: [{ src: '//path/to/video.mp4', type: 'video/mp4' }, { src: '//path/to/video.webm', type: 'video/webm' }]
detikVideo.vjsconf.techCanOverridePoster = false; // false, true
detikVideo.vjsconf.techOrder        = ['html5'];
detikVideo.vjsconf.nativeControlsForTouch = false; // false, true
detikVideo.vjsconf.nativeTextTracks = false; // false, true
detikVideo.vjsconf.nativeAudioTracks= false; // false, true for videojs-contrib-hls.js plugin
detikVideo.vjsconf.nativeVideoTracks= false; // false, true for videojs-contrib-hls.js plugin
detikVideo.vjsconf.children         = {
  mediaLoader: {},
  posterImage: {},
...
detikVideo.vjsconf.html5.hlsjsConfig= {};

detikVideo.hlsjsconf = {};
detikVideo.hlsjsconf.autoStartLoad  = false;
detikVideo.hlsjsconf.startPosition  = -1;
detikVideo.hlsjsconf.capLevelToPlayerSize= false;
detikVideo.hlsjsconf.debug          = false;
detikVideo.hlsjsconf.defaultAudioCodec = undefined;
detikVideo.hlsjsconf.initialLiveManifestSize = 1;
detikVideo.hlsjsconf.maxBufferLength= 30;
detikVideo.hlsjsconf.maxMaxBufferLength = 600;
detikVideo.hlsjsconf.maxBufferSize  = 60*1000*1000;
detikVideo.hlsjsconf.maxBufferHole  = 0.5;
detikVideo.hlsjsconf.lowBufferWatchdogPeriod  = 0.5;
detikVideo.hlsjsconf.highBufferWatchdogPeriod = 3;
detikVideo.hlsjsconf.nudgeOffset    = 0.1;
detikVideo.hlsjsconf.nudgeMaxRetry  = 15; // default is 3
detikVideo.hlsjsconf.maxFragLookUpTolerance   = 0.2;
detikVideo.hlsjsconf.liveSyncDurationCount    = 3;
detikVideo.hlsjsconf.liveMaxLatencyDurationCount = 10;
detikVideo.hlsjsconf.enableWorker   = true;
detikVideo.hlsjsconf.enableSoftwareAES        = false;
detikVideo.hlsjsconf.manifestLoadingTimeOut   = 10000;
detikVideo.hlsjsconf.manifestLoadingMaxRetry  = 1;
detikVideo.hlsjsconf.manifestLoadingRetryDelay= 500;
detikVideo.hlsjsconf.manifestLoadingMaxRetryTimeout = 64000;
detikVideo.hlsjsconf.startLevel     = 0;
detikVideo.hlsjsconf.levelLoadingTimeOut    = 10000;
detikVideo.hlsjsconf.levelLoadingMaxRetry   = 4;
detikVideo.hlsjsconf.levelLoadingRetryDelay = 500;
detikVideo.hlsjsconf.levelLoadingMaxRetryTimeout= 64000;
detikVideo.hlsjsconf.fragLoadingTimeOut     = 20000;
detikVideo.hlsjsconf.fragLoadingMaxRetry    = 6;
detikVideo.hlsjsconf.fragLoadingRetryDelay  = 500;
detikVideo.hlsjsconf.fragLoadingMaxRetryTimeout= 64000;
detikVideo.hlsjsconf.startFragPrefetch      = false;
detikVideo.hlsjsconf.appendErrorMaxRetry    = 3;
//detikVideo.hlsjsconf.loader                 = undefined; //detikVideo.hlsjsCustomLoader;
//detikVideo.hlsjsconf.fLoader                = undefined; //detikVideo.hlsjsCustomFragmentLoader;
//detikVideo.hlsjsconf.pLoader                = undefined; //detikVideo.hlsjsCustomPlaylistLoader;
//detikVideo.hlsjsconf.fetchSetup             = undefined; //detikVideo.hlsjsFetchSetupCallback;
//detikVideo.hlsjsconf.abrController          = undefined; //detikVideo.hlsjsCustomAbrController;
//detikVideo.hlsjsconf.timelineController     = undefined; //detikVideo.hlsjsTimelineController;
detikVideo.hlsjsconf.xhrSetup               = detikVideo.hlsjsXhrSetupCallback;
detikVideo.hlsjsconf.enableWebVTT         = false;
detikVideo.hlsjsconf.enableCEA708Captions = false;
detikVideo.hlsjsconf.stretchShortVideoTrack= false;
detikVideo.hlsjsconf.maxAudioFramesDrift = 1;
detikVideo.hlsjsconf.forceKeyFrameOnDiscontinuity = true;
detikVideo.hlsjsconf.abrEwmaFastLive      = 5.0;
detikVideo.hlsjsconf.abrEwmaSlowLive      = 9.0;
detikVideo.hlsjsconf.abrEwmaFastVoD       = 4.0;
detikVideo.hlsjsconf.abrEwmaSlowVoD       = 15.0;
detikVideo.hlsjsconf.abrEwmaDefaultEstimate= 500000;
detikVideo.hlsjsconf.abrBandWidthFactor   = 0.95;
detikVideo.hlsjsconf.abrBandWidthUpFactor = 0.7;
detikVideo.hlsjsconf.minAutoBitrate       = 0;

detikVideo.adsconf = {};
detikVideo.adsconf.id               = 'player'; // string of id
detikVideo.adsconf.adTagUrl         = null; // string URL of vastTag
detikVideo.adsconf.adTagUrlCopied   = null; // experimental, copied adsconf.adTagUrl in syncOthers
detikVideo.adsconf.adsResponse      = null; // string URL of adRules
detikVideo.adsconf.adsResponseCopied= null; // experimental, copied adsconf.adsResponseCopied in syncOthers
detikVideo.adsconf.adsRequest       = null; // Object of Params requested
detikVideo.adsconf.adLabel          = 'iklan'; // default is 'Iklan' string
detikVideo.adsconf.adLabelNofN      = 'dari'; // default is 'dari' string
detikVideo.adsconf.adsRenderingSettings = null; // Object of adsRenderingSettings in IMA Docs
detikVideo.adsconf.autoPlayAdBreaks = true; // boolean
detikVideo.adsconf.adWillAutoPlay   = undefined; // boolean but deprecated
detikVideo.adsconf.adWillPlayMuted  = undefined; // boolean but deprecated
detikVideo.adsconf.contribAdsSettings = null; // Object of contrib-ads plugin settings
detikVideo.adsconf.debug            = false;
detikVideo.adsconf.disableFlashAds  = true;
detikVideo.adsconf.disableCustomPlaybackForIOS10Plus = false; // boolean
detikVideo.adsconf.forceNonLinearFullSlot = false; // boolean
detikVideo.adsconf.locale           = 'id';  // 2 letters ex: 'en' or 'id'
detikVideo.adsconf.adsManagerWidth  = undefined; // bgfixadsmanager
detikVideo.adsconf.adsManagerHeight = undefined; // bgfixadsmanager
detikVideo.adsconf.nonLinearWidth   = null; // number please look at vjsconf
detikVideo.adsconf.nonLinearHeight  = null; // number please look at vjsconf
detikVideo.adsconf.numRedirects     = 4; // number, 4 follow Flowplayer
detikVideo.adsconf.showControlsForJSAds = true; // boolean
detikVideo.adsconf.showCountdown    = true; // boolean
detikVideo.adsconf.vastLoadTimeout  = 5000; // in milliseconds, number
detikVideo.adsconf.vpaidAllowed     = true; // boolean but deprecated
detikVideo.adsconf.vpaidMode        = 'ENABLED'; // 'ENABLED','DISABLED','INSECURE'
detikVideo.adsconf.adsManagerLoadedCallback         = undefined; // will be ctx.syncOthers to detikVideo.imaAdsManagerLoadedCallback
detikVideo.adsconf.adsManagerInstantiationCallback  = undefined; // will be ctx.syncOthers to detikVideo.imaAdsManagerInstantiationCallback
detikVideo.adsconf.linearAdStartedCallback          = undefined; // will be ctx.syncOthers to detikVideo.imaLinearAdStartedCallback

detikVideo.cbadsconf  = {};
detikVideo.cbadsconf.timeout        = 7000; // in milliseconds, number
detikVideo.cbadsconf.prerollTimeout = 7000; // in milliseconds, number
detikVideo.cbadsconf.postrollTimeout= 7000; // in milliseconds, number
detikVideo.cbadsconf.stitchedAds    = false; // boolean
detikVideo.cbadsconf.liveCuePoints  = false; // boolean // true is dangerous for preroll
detikVideo.cbadsconf.contentIsLive  = false; // boolean
detikVideo.cbadsconf.debug          = false; // boolean

detikVideo.vrconf = {};
detikVideo.vrconf.debug             = false;
detikVideo.vrconf.forceCardboard    = false; // boolean
detikVideo.vrconf.projection        = '360'; // 'NONE', 'AUTO', '360', '360_CUBE', '360_LR', '360_TB'
detikVideo.vrconf.player = {};
detikVideo.vrconf.player.mediainfo = {};
detikVideo.vrconf.player.mediainfo.projection = 'AUTO'; // 'NONE' or 'AUTO', '360', '360_CUBE', '360_LR', '360_TB'

detikVideo.vars = {};
detikVideo.vars.scriptMarker        = 'detikVideo.core.';
detikVideo.vars.scriptMarker2       = 'detikFlow.';
detikVideo.vars.scriptSrc           = null;
detikVideo.vars.v                   = null;
detikVideo.vars.xhrOpenOriginal     = null;
detikVideo.vars.vjsLoaderWaitingRetry = 0;
detikVideo.vars.textareaId            = 'detikVideoLog';
detikVideo.vars.textareaCheck         = 0;
detikVideo.vars.isLogTextareaEnabled  = null;
detikVideo.vars.textareaElement       = null;
detikVideo.vars.textareaElementLen    = null;
detikVideo.vars.textareaId2           = 'detikVideoLog2';
detikVideo.vars.textarea2Check        = 0;
detikVideo.vars.isLogTextareaEnabled2 = null;
detikVideo.vars.textareaElement2      = null;
detikVideo.vars.textareaElementLen2   = null;
detikVideo.vars.logModal              = null;
detikVideo.vars.scriptconfOriginalId  = null;
detikVideo.vars.isABDetected        = false;
detikVideo.vars.scriptSrcParams     = {};
detikVideo.vars.player              = null;
detikVideo.vars.imaAdsManager       = null; // object contain value from ima.getAdsManager()
detikVideo.vars.imaAdsRenderingSettings = null;
detikVideo.vars.cuePoints           = null; // array of integer in second(s)
detikVideo.vars.cuePointsObjects    = []; // [ { time: x, text: 'test'} ]
detikVideo.vars.hlsjsInstance       = null;
detikVideo.vars.vodBufferWhilePausedAutoStopNeeded  = false;
detikVideo.vars.liveBufferWhilePausedAutoStopNeeded = false;
detikVideo.vars.hlsjsXhrSetupCallback1stTouch       = false;
detikVideo.vars.xhrLastStatus       = 0;
detikVideo.vars.showXhrStatusModal  = [];
detikVideo.vars.drawAdCueMarkersOnce   = false;
detikVideo.vars.bufferWhilePausedAutoStopOnce   = false;
detikVideo.vars.bufferWhilePausedAutoStartOnce  = false;
detikVideo.vars.vjsGMenuButton          = null;
detikVideo.vars.vjsGMenu                = null;
detikVideo.vars.vjsGMItemLogModal       = null;
detikVideo.vars.vjsGMItemRelatedVideo   = null;
detikVideo.vars.vjsGMItemRelatedVideo3D = null;
detikVideo.vars.iframeRelatedVideoElement  = null;
detikVideo.vars.relatedVideoModal          = null;
detikVideo.vars.divRelatedVideo3DElement   = null;
detikVideo.vars.relatedVideoModal3D        = null;
detikVideo.vars.patchingHdButtonTitleDone  = false;
detikVideo.vars.carousel3DInit = false;
detikVideo.vars.hideSpinnerWhileAutoplayTrueLock = false;
detikVideo.vars.hideSpinnerWhileAutoplaySIHandler= null;
detikVideo.vars.canAutoplayVideo            = false;
detikVideo.vars.canAutoplayVideoMuted       = false;
detikVideo.vars.canAutoplayVideoInline      = false;
detikVideo.vars.canAutoplayVideoMutedInline = false;
detikVideo.vars.assumeNoPauseEvent          = false;
detikVideo.vars.assumeNoPlayEvent           = false;
detikVideo.vars.gsImaSuccess        = false;
detikVideo.vars.gsVjsAdsSuccess     = false;
detikVideo.vars.gsVjsImaSuccess     = false;
detikVideo.vars.gsReviverToNextStep = false;
detikVideo.vars.liveAdsIntervalNextIdx = 0;
detikVideo.vars.liveAdsIntervalHandler = null;
detikVideo.vars.pushstream  = null;
detikVideo.vars.pushstreamIsAllowMessage = false;
detikVideo.vars.isCountProgressCallback  = true;
detikVideo.vars.numProgressCallback      = 0;
detikVideo.vars.liveAdsCronLock     = false;
detikVideo.vars.liveAdsCronScheduleHandlers = [];
detikVideo.vars.liveAdsCronSIHandlers       = [];

// Chapter 3: Load internal libraries
/* detikVideo.Purl to parse http get params, please wait ... */
/*
...
/* end of detikVideo.Purl */



// Chapter 4: detikVideo Context as ctx
(function(ctx) {
  ...
  ctx.reRoute = function() {
    ...
    if (ctx.features.vTail === true) {
      if ((typeof ctx.vars.v) === 'string') {
        ...
        // ok give them all tails except detikVideo.libs.Ima
  ...
  ctx.gsDetectAB = function() {
    if (ctx.features.detectABWithFck === false) {
      // Non FckAdBlock detector (detikVideo.detect.js)
      if (ctx.features.getScriptToBodyAppend === false) {
        // JQuery getScripts
        $.ajaxSetup( { async: ctx.features.ajaxSetupASync , cache: ctx.features.ajaxSetupCache } );
      ...
      // FckAdBlock detector (detikVideo.detect2.js)
  ...
  ctx.coreInit = function() {
    ...
    //$(window).load(function() {
      ...
      ctx.showCoreVersion();
      if ((typeof onDetikVideoParams) !== 'function') {
        ctx.clog('params from scriptSrcParams()', null);
        ctx.vars.scriptSrcParams = ctx.scriptSrcParams();
      } else {
        ctx.clog('params from onDetikVideoParams()', null);
        ctx.vars.scriptSrcParams = onDetikVideoParams();
      };
  ...
  ctx.vjsLogModal = function() {
    if (detikVideo.features.logTextarea2 === true) {
  ...
  ctx.vjsRegisteringAllEvents = function() {
    ctx.vars.player.ready(function() {
      ...
      // call ctx.scriptconf.detikVideoLoadedCallback
  ...
  ctx.coreRun2 = function() {
    ...
    // registering all events of all plugins to detikVideo.core and detikVideo.portal
    ctx.xhrIASDetector();
    ctx.vjsLoader();
