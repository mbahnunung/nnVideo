...
nnVideo.libs.basePath      = 'https://ajax.bintangtenggarafm.com/nnVideo';
...
nnVideo.features.smartAutoplayTimoutPerStep = 300; // ms
...
nnVideo.features.liveAdsServerPushHost     = 'vidio.detik.com';
...
nnVideo.vjsconf.autoplay         = false;  // false, true, 'muted', 'play', 'any'
nnVideo.vjsconf.controls         = true;   // false, true
nnVideo.vjsconf.height           = undefined;   // string, number
nnVideo.vjsconf.width            = undefined;   // string, number
...
nnVideo.vars.canAutoplayVideo            = false;
